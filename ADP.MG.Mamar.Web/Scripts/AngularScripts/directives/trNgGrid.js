...
(function (TrNgGrid) {
    ...
    angular.module("trNgGrid", [])
        ...
        .run(function () {
            ...
            TrNgGrid.columnSortInactiveCssClass = "tr-ng-sort-inactive text-muted fa fa-caret-down";
            TrNgGrid.columnSortReverseOrderCssClass = "tr-ng-sort-order-reverse fa fa-caret-down";
            TrNgGrid.columnSortNormalOrderCssClass = "tr-ng-sort-order-normal fa fa-caret-up";
    ...
    function configureTemplates($templateCache, $interpolate) {
        ...
        addTemplate($templateCache, $interpolate, TrNgGrid.footerPagerTemplateId, '<span class="pull-right form-group">'
            ...
            + '     <a style="margin-top:10px;padding: 6px 9px 6px 9px;min-width: 2px;" href="" ng-click="pageCanGoBack&&navigateToPage(0)" ng-attr-title="{{\'First Page\'|' + TrNgGrid.translateFilter + ':gridOptions.locale}}">'
            + '         <span>&laquo;</span>'
            + '     </a>'
            + '   </li>'
            + '   <li ng-class="{disabled:!pageCanGoBack}" ng-if="extendedControlsActive">'
            + '     <a style="margin-top:10px;padding: 6px 9px 6px 9px;min-width: 2px;"  href="" ng-click="pageCanGoBack&&navigateToPage(gridOptions.currentPage - 1)" ng-attr-title="{{\'Previous Page\'|' + TrNgGrid.translateFilter + ':gridOptions.locale}}">'
            + '         <span>&lsaquo;</span>'
            + '     </a>'
            + '   </li>'
            ...
            + '      <span style="margin-top:10px;padding: 6px 9px 6px 9px;min-width: 2px;"  ng-if="pageIndex===null">...</span>'
            + '      <a style="margin-top:10px;padding: 6px 9px 6px 9px;min-width: 2px;"  href="" ng-click="navigateToPage(pageIndex)" ng-if="pageIndex!==null" ng-attr-title="{{\'Page\'|' + TrNgGrid.translateFilter + ':gridOptions.locale}}">{{pageIndex+1}}</a>'
            + '   </li>'
            + '   <li ng-class="{disabled:!pageCanGoForward}" ng-if="extendedControlsActive">'
            + '     <a style="margin-top:10px;padding: 6px 9px 6px 9px;min-width: 2px;"  href="" ng-click="pageCanGoForward&&navigateToPage(gridOptions.currentPage + 1)" ng-attr-title="{{\'Next Page\'|' + TrNgGrid.translateFilter + ':gridOptions.locale}}">'
            + '         <span>&rsaquo;</span>'
            + '     </a>'
            + '   </li>'
            + '   <li ng-class="{disabled:!pageCanGoForward}" ng-if="extendedControlsActive">'
            + '     <a style="margin-top:10px;padding: 6px 9px 6px 9px;min-width: 2px;"  href="" ng-click="pageCanGoForward&&navigateToPage(lastPageIndex)" ng-attr-title="{{\'Last Page\'|' + TrNgGrid.translateFilter + ':gridOptions.locale}}">'
            + '         <span>&raquo;</span>'
            + '     </a>'
            + '   </li>'
            + '   <li class="disabled" style="white-space: nowrap;">'
            //+ '     <span style="margin-top:10px" ng-hide="totalItemsCount">{{\'No items to display\'|' + TrNgGrid.translateFilter + ':gridOptions.locale}}</span>'
            + '     <span style="margin-top:10px;padding: 6px 9px 6px 9px;min-width: 2px;"  ng-hide="totalItemsCount">{{\'NoItems\'|translate}}</span>'
            //+ '     <span style="margin-top:10px" ng-show="totalItemsCount">'
            ////+ '       {{startItemIndex+1}} - {{endItemIndex+1}} {{\'displayed\'|' + TrNgGrid.translateFilter + ':gridOptions.locale}}'
            //+ '       {{startItemIndex+1}} - {{endItemIndex+1}} {{\'displayed\'|translate}}'
            ////+ '       <span>, {{totalItemsCount}} {{\'in total\'|' + TrNgGrid.translateFilter + ':gridOptions.locale}}</span>'
            //+ '       <span>, {{totalItemsCount}} {{\'total\' | translate}}</span>'
            + '     </span > '
            + '   </li>'
            + ' </ul>'
            + '</span>');
