angular.module('mamarApp').controller('TransactionBalanceController',
    ['$scope', '$rootScope', '$state', '$stateParams', '$filter', 'apiService', '$uibModal', 'sharedModels', 'userAccountStorageFactory',
        function ($scope, $rootScope, $state, $stateParams, $filter, apiService, $uibModal, sharedModels, userAccountStorageFactory) {
            ...
            $scope.DownloadGatePass = function (data) {
                ...
                apiService.get('Customs/Reporting/GetTransBalanceReport', $scope.gatePassParameter, function (results) {
                    $("#loadingScreen").hide();
