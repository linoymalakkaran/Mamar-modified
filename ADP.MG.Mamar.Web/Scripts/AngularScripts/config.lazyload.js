...
angular.module('mamarApp')
  ...
  .constant('JQ_CONFIG', {
      ...
      jspdf:          [   '../libs/assets/js-pdf/jspdf.min.js']
      ...
      },
      {
      ...
      },
        {
       ...
       
         {
             ...
             files: [
               '../libs/angular/angular-autocomplete/angucomplete-alt.js',
               '../libs/angular/angular-autocomplete/angucomplete-alt.css'
             ]
         },
        {
            name: 'ngMap',
            files: [
                '../libs/angular/ng-map/ng-map.min.js'
               ]
        },
        {
            name: 'ghiscoding.validation',
            files: [
                '../libs/angular/angular-validator/angular-validation.min.js'
            ]
        },
      {
          name:'ui.calendar',
